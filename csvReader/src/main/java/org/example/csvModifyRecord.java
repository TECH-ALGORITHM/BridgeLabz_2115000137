...
public class csvModifyRecord {
    public static void main(String[] args) {
        String path = "/home/AMBUJ/Desktop/csvReader/src/main/java/org/example/output.csv";
        String newpath = "/home/AMBUJ/Desktop/csvReader/src/main/java/org/example/modifyEmployee.csv";
